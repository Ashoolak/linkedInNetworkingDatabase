...
<body>
    <header>
        ...
        <form method="POST" action="manage-student-profile.php"> 
            ...
            <div class="input-row">
                <input type="text" name="year" class="input-column" placeholder="Year"> 
                <input type="text" name="gpa" class="input-column" placeholder="GPA"> 
            </div>
            ...
            <div class="section">
                ...
                <form method="POST" action="manage-student-profile.php"> 
                    ...
                    Account ID: <input type="text" name="deleted_accountID"> <br /><br />
    ...
    $success = True; //keep track of errors so it redirects the page only if there are no errors
        ...
        function handleUpdateRequest() {
            ...
            // Update the Users query based on the provided account ID
            ...
            $updateQueryStudent = "UPDATE Student SET
                GPA = '$gpa'
                WHERE student_accountID = '$accountID'";
        
            $stmt = oci_parse($db_conn, $updateQueryUsers);
            oci_execute($stmt);
        
            $stmt = oci_parse($db_conn, $updateQueryStudent);
            oci_execute($stmt);
        ...
        function handleDeleteRequest() {
            ...
            $accountID = $_POST['deleted_accountID'];
