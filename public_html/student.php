...
<body>
    <header>
        ...
        <div class="button-container">
            <a href="manage-student-profile.php" class="button">Manage Profile</a>
    ...
    <div class="container">
        <div class="section-container">
            ...
            <div class="section">
                <h2>Enroll Education</h2>
                <form method="POST" action="student.php"> 
                    <input type="hidden" id="insertEnrollEducation" name="insertEnrollEducation">
                    Account ID: <input type="text" name="student_accountID"> <br /><br />
                    School ID: <input type="text" name="schoolID"> <br /><br />
                    Faculty: <input type="text" name="faculty"> <br /><br />
                    Program Name: <input type="text" name="program_name"> <br /><br />
                    Start Date: <input type="date" name="start_day"> <br /><br />
    ...
    <?php
        ...
        function handleInsertEnrollEducation() {
            global $db_conn;
    ...
    function handlePOSTRequest() {
        if (connectToDB()) {
            ...
            } else if (array_key_exists('insertEnrollEducation', $_POST)) {
                handleInsertEnrollEducation();
            }
